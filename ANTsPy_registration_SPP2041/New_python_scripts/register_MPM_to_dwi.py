...
for entry in os.listdir(input_dir):
    ...
    if os.path.isdir(entry_path):
        r1 = ants.image_read(entry_path + '/6_mpm/results/mpm/R1.nii')
        r2s = ants.image_read(entry_path + '/6_mpm/results/mpm/R2s.nii')
        pd = ants.image_read(entry_path + '/6_mpm/results/mpm/PD.nii')
        mtsat = ants.image_read(entry_path + '/6_mpm/results/mpm/MTsat.nii')
